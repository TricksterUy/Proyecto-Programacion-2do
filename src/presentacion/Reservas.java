...
public class Reservas extends JFrame {
	...
	public Reservas() {
		...
		setTitle("Menu Principal de Reservas");
		setResizable(false);
		...
		JLabel lblReservas = new JLabel("Menu de Reservas");
		lblReservas.setHorizontalAlignment(SwingConstants.CENTER);
		lblReservas.setFont(new Font("Tahoma", Font.PLAIN, 30));
		lblReservas.setBounds(10, 10, 299, 64);
		...
		btnAltas.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				new AltaReservas().setVisible(true);
			}
		});
